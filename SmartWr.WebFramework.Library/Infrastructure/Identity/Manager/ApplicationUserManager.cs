...
namespace SmartWr.WebFramework.Library.Infrastructure.Identity.Manager
{
    public class ApplicationUserManager : IApplicationUserManager
    {
        ...
        public UserManager<ApplicationIdentityUser, int> UserManager
        {
            get
            {
                return _userManager;
        ...
        public virtual Task<ApplicationIdentityResult> AddUserToRoles(int userId, IList<string> roles)
        {
        ...
        public ApplicationIdentityResult Delete(int userId)
        {
            ...
            var identityResult = _userManager.Delete(applicationUser);
            return identityResult.ToApplicationIdentityResult();
        }
        ...
        public virtual ApplicationIdentityResult Update(AppUser user)
        {
            ...
            applicationUser.CopyAppUserProperties(user);
            var identityResult = _userManager.Update(applicationUser);
            return identityResult.ToApplicationIdentityResult();
        }
